...
import { fetchEoiDetails } from '../../redux/actions/detailActions';
import { connect } from 'react-redux';

import { Link } from 'react-router-dom'
import { Grid, List, Segment, Header, Form, Checkbox, Button, Modal } from 'semantic-ui-react';
...
class EoiDetail extends Component {
    ...
    handleToggle = (event) => {
        ...
        // ACTION:
        // modifyDetail(name) - send this to the redux store, and then change the field using action.payload.name = !action.payload.name
